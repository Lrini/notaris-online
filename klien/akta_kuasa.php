...
?>
                ...
                <?php endif; ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Form Akta Kuasa Menjual </h3></div>
                                    <div class="card-body">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputName1">Surat Nikah</label>
                                                <br>
                                                <label>untuk foto besar maks 1mb dan nama foto tidak menggunakan spasi</label>
                                                <input type="file" class="form-control" id="aktanikah" name="aktanikah" placeholder="Akta Nikah">
                                            </div>
                                           <div class="form-group">
                                                <label for="exampleInputName1">Kwintansi</label>
                                                <br>
                                                <label>untuk foto besar maks 1mb dan nama foto tidak menggunakan spasi</label>
                                                <input type="file" class="form-control" id="kwintansi" name="kwintansi" placeholder="Kwintansi">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputName1">Sertifikat Tanah</label>
                                                <br>
                                                <label>untuk foto besar maks 1mb dan nama foto tidak menggunakan spasi</label>
                                ...
                                <div class="card-body">
                                  <table id="contoh">
                                   ...
                                   <?php 
                                            include ('koneksi.php');
                                                        $data=$_SESSION['id'];
                                                        $sql =  mysqli_query($kon,"SELECT akta_kuasa.id,akta_kuasa.nama,akta_kuasa.alamat,akta_kuasa.no_hp,akta_kuasa.ktp,akta_kuasa.suratnikah,akta_kuasa.kwintansi,akta_kuasa.PBB,akta_kuasa.sertifikat,klien.id as klienid,klien.nama from akta_kuasa INNER JOIN klien on akta_kuasa.nama = klien.id WHERE klien.id = $data");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo "<a href='#' class='tansi btn btn-success' data-id=".$row['id']."><i class='ik ik-camera'></i></a>  "?></td>
                            ...
                            <div class="modal fade" id="tansi" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg mt-0 mb-0">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                                <h3>Kwintasi</h3>
...
<script>
    ...
    <script>
     ...
     <script>
         $(function(){
            $(document).on('click','.tansi',function(e){
                e.preventDefault();
                $("#tansi").modal('show');
                $.post('modal/modal_tansi.php',
                    {id:$(this).attr('data-id')},
                    function(html){
                        $(".modal-body").html(html);
                    }   
    ...
    <script>
         $(function(){
            $(document).on('click','.ikat',function(e){
                e.preventDefault();
                $("#ikat").modal('show');
                $.post('modal/modal_sertifikat2.php',
                    {id:$(this).attr('data-id')},
                    function(html){
                        $(".modal-body").html(html);
                    }   
