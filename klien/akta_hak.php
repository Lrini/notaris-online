...
?>
                ...
                <?php endif; ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Form Akta Pembagian Hak </h3></div>
                                    <div class="card-body">
                                ...
                                <div class="card-body">
                                  <table id="contoh">
                                   ...
                                   <?php 
                                            include ('koneksi.php');
                                                        $data=$_SESSION['id'];
                                                        $sql =  mysqli_query($kon,"SELECT akta_hak.id,akta_hak.nama,akta_hak.alamat,akta_hak.no_hp,akta_hak.ktp,akta_hak.aktanikah,akta_hak.kk,akta_hak.PBB,akta_hak.sertifikat,akta_hak.npwp, klien.id as klienid,klien.nama FROM akta_hak INNER JOIN klien ON akta_hak.nama=klien.id WHERE klien.id = $data");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo "<a href='#' class='kelu btn btn-success' data-id=".$row['id']."><i class='ik ik-camera'></i></a>  "?></td>
             ...
             <div class="modal fade" id="aktp" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                            ...
                            <div class="modal fade" id="kelu" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg mt-0 mb-0">
                                    <div class="modal-content">
                                        <div class="modal-header">
...
<script>
    ...
    <script>
         $(function(){
            $(document).on('click','.kelu',function(e){
                e.preventDefault();
                $("#kelu").modal('show');
                $.post('modal/modal_kk.php',
                    {id:$(this).attr('data-id')},
                    function(html){
                        $(".modal-body").html(html);
                    }   
    ...
    <script>
         $(function(){
            $(document).on('click','.sertifikat',function(e){
                e.preventDefault();
                $("#ikat").modal('show');
                $.post('modal/modal_sertifikat.php',
                    {id:$(this).attr('data-id')},
                    function(html){
                        $(".modal-body").html(html);
                    }   
