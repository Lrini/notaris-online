...
?>
                ...
                <?php endif; ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Form Akta Pendirian PT </h3></div>
                                    <div class="card-body">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputName1">Modal Awal</label>
                                                <br>
                                                <input type="text" class="form-control" id="modal" name="modal" placeholder="modal">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputName1">Nama Komisaris</label>
                                                <br>
                                                <input type="text" class="form-control" id="komisaris" name="komisaris" placeholder="komisaris">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <input type="text" class="form-control" id="nama_pt" name="nama_pt" placeholder="nama_pt">
                                            </div>
                                ...
                                <div class="card-body">
                                  <table id="contoh">
                                   ...
                                   <?php 
                                            include ('koneksi.php');
                                                        $data=$_SESSION['id'];
                                                        $sql =  mysqli_query($kon,"SELECT akta_pt.id,akta_pt.nama,akta_pt.alamat,akta_pt.no_hp,akta_pt.ktp,akta_pt.modal,akta_pt.nama_pt,akta_pt.komisaris,akta_pt.direktur,klien.id as klienid, klien.nama FROM akta_pt INNER JOIN klien ON akta_pt.nama= klien.id WHERE klien.id = $data");
