...
?>
                ...
                <?php endif; ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Form Akta Jual Beli </h3></div>
                                    <div class="card-body">
                                ...
                                <div class="card-body">
                                  <table id="contoh">
                                   ...
                                   <?php 
                                            include ('koneksi.php');
                                                        $data=$_SESSION['id'];
                                                        $sql =  mysqli_query($kon," SELECT akta_jualbeli.id ,akta_jualbeli.nama,akta_jualbeli.alamat,akta_jualbeli.no_hp,akta_jualbeli.ktp,akta_jualbeli.akta_lahir,akta_jualbeli.PBB,akta_jualbeli.sertifikat,akta_jualbeli.npwp,klien.id as klienid , klien.nama FROM akta_jualbeli INNER JOIN klien ON akta_jualbeli.nama = klien.id WHERE klien.id = $data");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo "<a href='#' class='lahir btn btn-success' data-id=".$row['id']."><i class='ik ik-camera'></i></a>  "?></td>
             ...
             <div class="modal fade" id="addklien" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                            ...
                            <div class="modal fade" id="lahir" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg mt-0 mb-0">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                                <h3>AKTA LAHIR</h3>
...
<script>
    ...
    <script>
         $(function(){
            $(document).on('click','.lahir',function(e){
                e.preventDefault();
                $("#lahir").modal('show');
                $.post('modal/modal_foto1.php',
                    {id:$(this).attr('data-id')},
                    function(html){
                        $(".modal-body").html(html);
                    }   
