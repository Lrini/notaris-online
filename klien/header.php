                        ...
                        <div class="top-menu d-flex align-items-center">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="../loginklien.php"><i class="ik ik-power dropdown-icon"></i> Logout</a>
                                </div>
                            </div>
                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item">
                                    <a href="admin.php"><i class="ik ik-users"></i><span>Admin</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="rekening.php"><i class="ik ik-users"></i><span>Rekening</span></a>
                                </div>
                                 <div class="nav-item">
                                    <a href="rekening.php"><i class="ik ik-users"></i><span>Pembayaran</span></a>
                                </div>
                                 <div class="nav-item">
                                    <a href="login.php"><i class="ik ik-users"></i><span>Login Pengguna</span></a>
                                </div>-->
                                ...
                                <div class="nav-item">
                                    <a href="dokumen.php"><i class="ik ik-lock"></i><span>Dokumen</span></a>
                                     <a href="Pembayaran.php"><i class="ik ik-lock"></i><span>Pembayaran</span></a>
                                </div>
                            </nav>
                        </div>
                    </div>
