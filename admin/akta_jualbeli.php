                            ...
                            <div class="card">
                                <div class="card-body">
                                  <table id="contoh">
                                   ...
                                   <?php 
                                            include ('koneksi.php');
                                                        $sql =  mysqli_query($kon," SELECT akta_jualbeli.id ,akta_jualbeli.nama,akta_jualbeli.alamat,akta_jualbeli.no_hp,akta_jualbeli.ktp,akta_jualbeli.akta_lahir,akta_jualbeli.PBB,akta_jualbeli.sertifikat,akta_jualbeli.npwp,klien.id as klienid , klien.nama FROM akta_jualbeli INNER JOIN klien ON akta_jualbeli.nama = klien.id");
                                    ...
                                    ?>
                                        <tr>
                                           ...
                                           <td><a href="proses/hapus_jualbeli.php?id=<?= $row["id"];?>"><i class="ik ik-trash-2 f-16 text-red"></i></a></td> 
                                        </tr>
                                    <?php
                                        }  
                                    ?> 
