                                ...
                                <div class="card-body">
                                  <table id="contoh">
                                   ...
                                   <?php 
                                            include ('koneksi.php');
                                                        $data=$_SESSION['id'];
                                                        $sql =  mysqli_query($kon,"SELECT akta_hak.id,akta_hak.nama,akta_hak.alamat,akta_hak.no_hp,akta_hak.ktp,akta_hak.aktanikah,akta_hak.kk,akta_hak.PBB,akta_hak.sertifikat,akta_hak.npwp, klien.id as klienid,klien.nama FROM akta_hak INNER JOIN klien ON akta_hak.nama=klien.id");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo "<a href='#' class='np btn btn-success' data-id=".$row['id']."><i class='ik ik-camera'></i></a>  "?></td>
                                               ...
                                               <td><a href="proses/hapus_hak.php?id=<?= $row["id"];?>"><i class="ik ik-trash-2 f-16 text-red"></i></a></td>
                                        </tr>
                                    <?php
                                        }  
                                    ?> 
