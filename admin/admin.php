...
?>
                ...
                <?php endif; ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Form Admin</h3></div>
                                    <div class="card-body">
                                  ...
                                  <table id="contoh">
                                   ...
                                   <?php foreach ($admin as $row): ?>
                                        <tr>
                                            ...
                                            <td><?= $row["pass"];?></td>
                                            <td>
                                                <?php echo "<a href='#' class='lihat btn btn-primary' data-id=".$row['id_admin']."><i class='ik ik-edit-1'></i></a>  "?>
                                                <a href="proses/hapusadmin.php?id_admin=<?= $row["id_admin"];?>"><i class="ik ik-trash-2 f-16 text-red"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?> 
                                    </tbody>
             ...
             <div class="modal fade" id="addadmin" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
