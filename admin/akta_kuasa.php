                                ...
                                <div class="card-body">
                                  <table id="contoh">
                                   ...
                                   <?php 
                                            include ('koneksi.php');
                                                        $data=$_SESSION['id'];
                                                        $sql =  mysqli_query($kon,"SELECT akta_kuasa.id,akta_kuasa.nama,akta_kuasa.alamat,akta_kuasa.no_hp,akta_kuasa.ktp,akta_kuasa.suratnikah,akta_kuasa.kwintansi,akta_kuasa.PBB,akta_kuasa.sertifikat,klien.id as klienid,klien.nama from akta_kuasa INNER JOIN klien on akta_kuasa.nama = klien.id");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo "<a href='#' class='pbb btn btn-success' data-id=".$row['id']."><i class='ik ik-camera'></i></a>  "?></td>
                                             <td><a href="proses/hapus_kuasa.php?id=<?= $row["id"];?>"><i class="ik ik-trash-2 f-16 text-red"></i></a></td>
                                        </tr>
                                    <?php
                                        }  
                                    ?> 
