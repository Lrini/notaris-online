                                ...
                                <div class="card-body">
                                  <table id="contoh">
                                   ...
                                   <?php 
                                            include ('koneksi.php');
                                                        $data=$_SESSION['id'];
                                                        $sql =  mysqli_query($kon,"SELECT akta_pt.id,akta_pt.nama,akta_pt.alamat,akta_pt.no_hp,akta_pt.ktp,akta_pt.modal,akta_pt.nama_pt,akta_pt.komisaris,akta_pt.direktur,klien.id as klienid, klien.nama FROM akta_pt INNER JOIN klien ON akta_pt.nama= klien.id");
                                            ...
                                            <td><?php echo "<a href='#' class='foto1 btn btn-success' data-id=".$row['id']."><i class='ik ik-camera'></i></a>  "?></td>
                                             <td><?= $row["direktur"];?></td>
                                              <td><?= $row["komisaris"];?></td>
                                               <td><?= $row["modal"];?></td>
                                                <td><?= $row["nama_pt"];?></td>
                                                 <td><a href="proses/hapus_pt.php?id=<?= $row["id"];?>"><i class="ik ik-trash-2 f-16 text-red"></i></a></td>
                                        </tr>
                                    <?php
                                        }  
                                    ?> 
