                                ...
                                <div class="card-body">
                                  <table id="contoh">
                                   ...
                                   <?php 
                                            include ('koneksi.php');
                                                        $data=$_SESSION['id'];
                                                        $sql =  mysqli_query($kon," SELECT akta_nikah.id, akta_nikah.nama,akta_nikah.alamat,akta_nikah.no_hp,akta_nikah.ktp,akta_nikah.kk,akta_nikah.aktanikah,akta_nikah.sertifikat,akta_nikah.npwp,klien.id as klienid FROM akta_nikah INNER JOIN klien on akta_nikah.nama = klien.id");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="proses/hapus_tukar.php?id=<?= $row["id"];?>"><i class="ik ik-trash-2 f-16 text-red"></i></a></td>
                                        </tr>
                                    <?php
                                        }  
                                    ?> 
